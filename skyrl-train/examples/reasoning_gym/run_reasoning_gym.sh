...
# uv run --with reasoning_gym -- python examples/reasoning_gym/generate_datasets.py --output_dir $HOME/data/reasoning_gym \
...
DATA_DIR="$HOME/data/reasoning_gym"
LOGGER="console"
NUM_GPUS=1

uv run --isolated --extra $INFERENCE_BACKEND --with reasoning_gym -m skyrl_train.entrypoints.main_base \
