...
For a more detailed explanation of the task and training configuration, see [../examples/search](../examples/search).

## Pre-requisites

Make sure to have followed the installation commands in [../getting-started/installation](../getting-started/installation).
