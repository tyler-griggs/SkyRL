...
This example demonstrates how to run PPO training on GSM8K. See [../getting-started/quickstart](../getting-started/quickstart) for a similar setup process for GRPO!
...
- [../examples/remote_server](../examples/remote_server): Training with a remote inference engine